...
CREATE TABLE `zzz_2021_national_activity_dingdan` (
  `id` int(20) unsigned NOT NULL AUTO_INCREMENT,
  `count_date` date NOT NULL DEFAULT '2001-01-01' COMMENT '统计日期',
  `login_count_user_total` int(11) NOT NULL DEFAULT '0' COMMENT '活跃用户人数',
  `produce_lucky_count_user_total` int(11) NOT NULL DEFAULT '0' COMMENT '产生幸运值人数',
  `get_lucky_count_user_total` int(11) NOT NULL DEFAULT '0' COMMENT '领取幸运值人数',
  `produce_lucky_sum_total` int(11) NOT NULL DEFAULT '0' COMMENT '产出幸运值数量',
  `get_lucky_sum_total` int(11) NOT NULL DEFAULT '0' COMMENT '领取幸运值数量',
  `dingdan_count_user_total` int(11) NOT NULL DEFAULT '0' COMMENT '产生订单人数',
  `dingdan_count_total` int(11) NOT NULL DEFAULT '0' COMMENT '产生订单数量',
  `dingdan_sum_pm_total` int(11) NOT NULL DEFAULT '0' COMMENT '产生订单金额',
